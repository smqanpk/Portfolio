...
export default function PostGISExplorer() {
  return (
    <main className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
      <DBHero
        title="PostGIS Spatial Data Explorer"
        subtitle="Interactive spatial SQL & geometry visualization"
      />
      ...
      <div className="mt-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-4 text-sm sm:text-base">
            A web-based interface for running spatial SQL queries, visualizing
            geometries, and exploring geographic datasets directly from PostGIS.
          </p>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 text-sm text-gray-700 dark:text-gray-300">
              ...
              <li>Geometry inspection & bounding box queries</li>
        ...
        <aside className="rounded-lg bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-3">
          ...
          <Link to="/projects/advanced-web-gis" className="block text-center px-3 py-2 border rounded-md text-sm">
            See Advanced Web GIS
          </Link>
        </aside>
      </div>
    </main>
